...
use App\Repository\KadrKat1Repository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\HttpFoundation\File\File;
use Symfony\Component\HttpFoundation\File\UploadedFile;
use Vich\UploaderBundle\Mapping\Annotation as Vich;

#[ORM\Entity(repositoryClass: KadrKat1Repository::class)]
class KadrKat1
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    //uploader start
    #[Vich\UploadableField(mapping: 'kadry', fileNameProperty: 'imageName', size: 'imageSize')]
