...
use App\Repository\KsieKat2Repository;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\HttpFoundation\File\File;
use Symfony\Component\HttpFoundation\File\UploadedFile;
use Vich\UploaderBundle\Mapping\Annotation as Vich;

#[ORM\Entity(repositoryClass: KsieKat2Repository::class)]
class KsieKat2
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    //uploader start
    #[Vich\UploadableField(mapping: 'ksiegowosc', fileNameProperty: 'imageName', size: 'imageSize')]
