...
class InnKat3CrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return InnKat3::class;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle('index', 'Lista Intrukcji')
            ->setPageTitle('detail', fn (InnKat3 $nazwa) => (string) $nazwa)
