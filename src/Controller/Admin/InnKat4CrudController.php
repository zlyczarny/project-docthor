...
class InnKat4CrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return InnKat4::class;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle('index', 'Lista Certyfikatów')
            ->setPageTitle('detail', fn (InnKat4 $nazwa) => (string) $nazwa)
