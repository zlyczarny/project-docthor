...
{% block body %}
    ...
    <p>
        Jeżeli istnieje konto połączone z podanym adresem email, zostanie wysłana wiaodmość email zawierający link resetowania hasła.
        Link przedawni się za {{ resetToken.expirationMessageKey|trans(resetToken.expirationMessageData, 'ResetPasswordBundle') }}.
    </p>
...
{% endblock %}
", "reset_password/check_email.html.twig", "C:\\xampp\\htdocs\\docthor — kopia (2)\\templates\\reset_password\\check_email.html.twig");
    }
}
