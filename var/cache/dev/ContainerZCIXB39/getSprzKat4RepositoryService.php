 ...
 */
class getSprzKat4RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SprzKat4Repository' shared autowired service.
     *
     * @return \App\Repository\SprzKat4Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SprzKat4Repository.php';

        return $container->privates['App\\Repository\\SprzKat4Repository'] = new \App\Repository\SprzKat4Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
