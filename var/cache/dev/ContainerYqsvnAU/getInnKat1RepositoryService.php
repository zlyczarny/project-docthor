 ...
 */
class getInnKat1RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InnKat1Repository' shared autowired service.
     *
     * @return \App\Repository\InnKat1Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InnKat1Repository.php';

        return $container->privates['App\\Repository\\InnKat1Repository'] = new \App\Repository\InnKat1Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
