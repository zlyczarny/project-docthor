 ...
 */
class getSprzKat2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SprzKat2Repository' shared autowired service.
     *
     * @return \App\Repository\SprzKat2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SprzKat2Repository.php';

        return $container->privates['App\\Repository\\SprzKat2Repository'] = new \App\Repository\SprzKat2Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
