 ...
 */
class getKadrKat2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\KadrKat2Repository' shared autowired service.
     *
     * @return \App\Repository\KadrKat2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'KadrKat2Repository.php';

        return $container->privates['App\\Repository\\KadrKat2Repository'] = new \App\Repository\KadrKat2Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
